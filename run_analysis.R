...
tidyData <- cbind(X_merged,labels_activity,sub_merged)
tidyData_mean <- tidyData %>% group_by(labels_activity, Subject) %>% summarise_each(funs(mean))
View(tidyData_mean)
